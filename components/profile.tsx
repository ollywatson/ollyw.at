...
const Profile = () => {
    return (
        <div className="px-[26px]">
            ...
            <div className="mt-8">
                <p className="text-base text-secondary">Over the past decade, I’ve worked in consulting, agencies and startups, at many stages of the product development life cycle, from ethnographic research to brand to design engineering. I designed and built <Link href="https://www.deliveroo.design/" className="inline-link text-primary">Voicey</Link>, an iPhone app for voice messaging.</p>
            </div>
